...
*/
        ...
        #include "map_files\HeavenStation\z1.dmm"
        #include "map_files\generic\z2.dmm"
        #include "map_files\generic\z3.dmm"
        #include "map_files\generic\z4.dmm"
        #include "map_files\HeavenStation\z5.dmm"
        #include "map_files\generic\z6.dmm"
        #include "map_files\generic\z7.dmm"
        #include "map_files\TerrorStation\z9.dmm" //prison

		#define MAP_PATH "map_files/HeavenStation"
        #define MAP_FILE "z1.dmm"
        #define MAP_NAME "Heaven Station"
	...
	#warn a map has already been included, ignoring Heaven Station.
