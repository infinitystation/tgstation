...
/obj/machinery/mineral/equipment_vendor/golem/Initialize()
	...
	prize_list += list(
		...
		new /datum/data/mining_equipment("Monkey Cube",				/obj/item/reagent_containers/food/snacks/monkeycube,        		600),
		new /datum/data/mining_equipment("Toolbelt",				/obj/item/storage/belt/utility,	    							700),
		...
		new /datum/data/mining_equipment("The Liberator's Legacy",  /obj/item/storage/box/rndboards,      			      			3000),
