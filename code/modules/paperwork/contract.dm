...
/obj/item/weapon/paper/contract/infernal/suicide_act(mob/user)
	if(signed && (user == target.current) && istype(user,/mob/living/carbon/human/))
		...
		H.forcesay("Œ ¬≈À» »… »Õ‘≈–ÕŒ!  ﬂ “–≈¡”ﬁ, ◊“Œ¡€ “€ Õ≈Ã≈ƒÀ≈ÕÕŒ «¿¡–¿À —¬Œ… “–Œ‘≈… —≈¡≈!")
		H.visible_message("<span class='suicide'>[H] ‰ÂÊËÚ ÍÓÌÚ‡ÍÚ, ÛÚ‚ÂÊ‰‡&#255; ‰Û¯Ë, Á‡ÚÂÏ Ò‡ÁÛ ÊÂ ‚ÓÒÔÎ‡ÏÂÌ&#255;ÂÚÒ&#255;.   ‡ÊÂÚÒ&#255; [user.p_they()] Ô˚Ú‡Î[user.p_e_5()] ÔÓÍÓÌ˜ËÚ¸ ÊËÁÌ¸ Ò‡ÏÓÛ·ËÈÒÚ‚ÓÏ!</span>")
