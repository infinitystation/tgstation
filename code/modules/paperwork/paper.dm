...
/obj/item/weapon/paper/centcom
	...
	info = "<BR>—лужба Ѕезопасности ÷ <BR>ѕортовое отделение<BR>ќффициальный документ<BR><BR>»нспектор,<BR>Ёвакуационный шаттл прибудет сегодня.<BR><BR>–азрешайте проход только членам корпорации Ќанотрайзен. ќ каждом челевеке, что не является членом корпорации Ќанотрайзен, сообщайте охране.  расная кнопка под столом.<BR><BR>«аведующий портового отделения"
