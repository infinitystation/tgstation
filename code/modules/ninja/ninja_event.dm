...
/datum/round_event/ghost_role/ninja/spawn_role()
	...
	//add some RP-fluff
	Mind.store_memory("я - элитный наемник из  лана ѕаука. я - это <font color='red'><B>космический ниндзя.</B></font>!")
	Mind.store_memory("Ќеожиданность - мое оружие. “ень - моя броня. Ѕез них - я ничто. (//запустите инициализацию костюма, чтобы получить доступ к стелс-режиму и прочему)!")
