...
/client/New(TopicData)
	...
	if (isnum(player_age) && player_age == -1) //first connection
		...
		if (config.notify_new_player_age >= 0)
			message_admins("<span class='adminnotice'><b><font color=red>Ê ñåðâåðó ïðèñîåäèíèëñß èãðîê. </font>Byond login: [key_name(src)]. ÂÍÈÌÀÍÈÅ - ÏÅÐÂÛÉ ÐÀÇ Â ÆÈÇÍÈ ÍÀ ÑÅÐÂÅÐÅ. IP: [address]</span>")
		...
		message_admins("<span class='adminnotice'><b><font color=red>Ê ñåðâåðó ïðèñîåäèíèëñß èãðîê. </font>Byond login: [key_name_admin(src)]. Â ïåðâûå áûë íà ñåðâåðå [player_age] äíåé íàçàä. IP: [address]</span>")
	...
	if(event_on_air)
		src << "<span class='info'>Íà ñåðâåðå [ticker ? "èäåò" : "ãîòîâèòñ&#255;"] èâåíò. Ïîäðîáíîñòè ÷èòàéòå çäåñü: [event_url] èëè â Admin -> Admin-Notice. Òàêæå ìîæåòå ñïðîñèòü àäìèíèñòðàöèþ ÷åðåç Adminhelp (F1)</span>"
