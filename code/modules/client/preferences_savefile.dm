...
/datum/preferences/proc/load_character(slot)
	...
	features["tail_tajaran"]	= sanitize_inlist(features["tail_tajaran"], GLOB.tails_list_lizard, "Default")
	features["snout"]	= sanitize_inlist(features["snout"], GLOB.snouts_list)
	features["horns"] 	= sanitize_inlist(features["horns"], GLOB.horns_list)
	features["ears"]	= sanitize_inlist(features["ears"], GLOB.ears_list, "None")
	features["ears_tajaran"]	= sanitize_inlist(features["ears_tajaran"], GLOB.ears_list_tajaran, "Default")
...
/datum/preferences/proc/save_character()
	...
	//Infinity specs
	WRITE_FILE(S["visual_age"], visual_age)
	WRITE_FILE(S["feature_human_tajaran"], features["tail_tajaran"])
	WRITE_FILE(S["feature_tajaran_ears"], features["ears_tajaran"])
	WRITE_FILE(S["be_blinded"], be_blinded)
	WRITE_FILE(S["be_nearsight"], be_nearsight)
	WRITE_FILE(S["be_deaf"], be_deaf)
