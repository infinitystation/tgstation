...
/obj/item/weapon/paper/syndicate
	name = "Message"
	info = "<i>В вашем автомате YouTool было обновлено оборудование, в коробку из-под пицы положили новую пиццу.<br>Немного изменили конструкцию медицинского отсека вашего корабля - добавили тюрьму.<br>В отдел инженреного оборудования был добавлен Пластаниум для ремонта корабля в случае поломки.<br>Развлекайтесь."
