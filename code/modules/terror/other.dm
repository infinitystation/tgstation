...
/obj/structure/fluff/shuttle_AI
	...
	desc = "ИспользуетсЯ длЯ непосредственного удаленного контролЯ из центра свЯзи Центрального КоммандованиЯ. Ни на что не годен и по слухам, внутри ничего нет. Серьезно."
	icon = 'icons/obj/infinity_object.dmi'
	icon_state = "tracker"
	anchored = 1
	density = 1
