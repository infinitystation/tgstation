...
/obj/item/weapon/storage/box/mining/survival
	name = "survival pack"
	desc = "Ïîìîæåò ïðîæèòü íà ïîë ìèíóòû äîëüøå."
...
/obj/item/weapon/paper/parting
	name = "Parting"
	info = "<b><center>Ðóêîâîäñòâî ïî ýêñïëóàòàöèè ýëåêòðè÷åñêîãî ñòóëà</center></b><br><br> 1) Âîçüìèòå electrpack(øîêîâûé ðþêçàê) â ðóêó è ïðîâåäèòå íàñòðîéêó ÷àñòîò. Îáðàòèò âíèìàíèå, ÷òî ñòàíäàðòíûå ÷àñòîòû (144.9 ñ êîäîì 2) - äå àêòèâèðîâàíû ñ öåëüþ èçáåæàíèß ñàáîòàæà â ðàáîòå ñòóëà. Èçìåíèòå ÷àñòîòó è êîä. Íèêîìó íå ñîîáùàéòå êîä ïîìèìî ÕîÑà, âàðäåíà èëè êàïèòàíà.<br> 2) Ïðèñîåäåíèòå ê electropack øëåì - âû ïîëó÷èòå øîêîâûé íàáîð.<br> 3) Çàêðåïèòå øîêîâûé íàáîð íà ñòóëå.<br> 4) Íàñòðîéòå signaler íà âûñòàâëåííóþ â ýëåêòðîïàêå ÷àñòîòó. Âñ¸, ýëåêòðè÷åñêèé ñòóë ãîòîâ.<br><br><b><center>Îáñëóæèâàíèå ýëåêòðè÷åñêîãî ñòóëà</centrl></b><br>*Äëß îòñîåäèíåíèß øîêîâîãî íàáîðà îò ñòóëà, èñïîëüçóéòå ãàå÷íûé êëþ÷. Äëß ðàçîåäåíåíèß ÷àñòåé - òàê æå.<br>*Ñòóë èìååò çàäåðæêó ïåðåä èñïîëüçîâàíèåì - âñåãî íåñêîëüêî ñåêóíä.<br>*Äëß ïðîâåäåíèß êàçíè, çàêðåïèòå îñóæäåííîãî íà ýëåêòðè÷åñêîì ñòóëå è àêòèâèðóéòå ñèãíàëëåð.<br><br><br><small>Óâàæàåìûé îïåðàòîð, ïîæàëóéñòà, ïîìíèòå, ÷òî íà ýòîì ñòóëå âû ïðîèçâîäèòå êàçíü æèâîãî ÷åëîâåêà - òàêîãî æå, êàê è âû.<br> Íå çàáûâàéòå îá ýòîì èñïîëüçóéòå åãî â ñàìîì êðàéíåì ñëó÷àå.</small>"
