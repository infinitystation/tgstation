...
/obj/item/bodypart/proc/get_limb_icon(dropped)
	...
	if(status == BODYPART_ORGANIC)
		...
		if(should_draw_gender)
			I = image("icon"='icons/mob/augments.dmi', "[initial(icon_state)]"="[icon_state]_[icon_gender]", "layer"=-BODYPARTS_LAYER, "dir"=image_dir)
		else
			I = image("icon"='icons/mob/augments.dmi', "[initial(icon_state)]"="[icon_state]", "layer"=-BODYPARTS_LAYER, "dir"=image_dir)
		standing += I
		return standing
