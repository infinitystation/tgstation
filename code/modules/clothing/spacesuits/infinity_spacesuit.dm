...
obj/item/clothing/head/helmet/space/hardsuit/engine_unathi
	...
	desc = "A special helmet designed for work in a hazardous, low pressure environment. Built with lightweight materials for extra comfort, but does not protect the eyes from intense light."
	icon_state = "hardsuit-engineering_unathi_helm"
	item_state = "hardsuit-engineering_unathi_helm"
...
/obj/item/clothing/head/helmet/space/hardsuit/atmos_unathi
	name = "unathi hardsuit helmet"
	desc = "A special helmet designed for work in a hazardous, low pressure environment. Built with lightweight materials for extra comfort, but does not protect the eyes from intense light."
	icon_state = "hardsuit-atmos_unathi_helm"
	item_state = "hardsuit-atmos_unathi_helm"
	item_color = "engineering"
	worn_icon = 'icons/mob/infinity_work.dmi'
	icon = 'icons/obj/clothing/infinity_work.dmi'
	flash_protect = 0
