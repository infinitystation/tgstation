...
/obj/machinery/smartfridge/chemistry/central_command
	initial_contents = list(
		/obj/item/reagent_containers/pill/epinephrine = 15,
		...
		/obj/item/reagent_containers/pill/patch/silver_sulf = 10,
		/obj/item/reagent_containers/pill/patch/styptic = 10,
		/obj/item/reagent_containers/pill/potass = 10,
