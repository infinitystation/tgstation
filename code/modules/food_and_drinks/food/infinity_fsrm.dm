...
/obj/item/reagent_containers/food/snacks/fsrm
	icon = 'icons/obj/food/infinity_fsrm.dmi'

/obj/item/reagent_containers/food/snacks/fsrm/sosjerky
	name = "Gunnery Sergeant Hartman's Reserve Jerky"
	desc = "With taste of hellish physical loads and discipline."
...
/obj/item/reagent_containers/food/snacks/fsrm/choclate
	name = "Hershey Chocolate"
	desc = "It withstands high temperatures.Take a break in the killings, eat chocolate."
...
/obj/item/reagent_containers/food/snacks/fsrm/pork
	name = "Lieutenant Rico's canned pork"
	desc = "Tasty nutritious meat in full metal jacket."
...
/obj/item/reagent_containers/food/drinks/soda_cans/fsrm_tonic
	name = "Berserker Energy Drink"
...
/obj/item/reagent_containers/pill/vitamin
...
/obj/item/storage/box/fsrm/New()
	...
	new /obj/item/reagent_containers/food/snacks/fsrm/pork(src)
	new /obj/item/reagent_containers/food/snacks/fsrm/choclate(src)
	new /obj/item/reagent_containers/food/snacks/fsrm/sosjerky(src)
	new /obj/item/reagent_containers/food/condiment/pack/sugar(src)

/obj/item/storage/box/fsrm/update_icon()
	..()
...
/obj/machinery/vending/snack
	..()
	premium = list(/obj/item/storage/box/fsrm = 1)
