...
/datum/round_event/shuttle_loan/announce()
	...
	switch(dispatch_type)
		...
		if(SPIDER_GIFT)
			priority_announce("Грузовой отдел: Клан Паука послал нам загадочный подарок, можем ли мы переслать его вам, чтобы узнать, что там внутри?","Дипломатический Корпус Центрального командованиЯ")
		if(DEPARTMENT_RESUPPLY)
			priority_announce("Грузовой отдел: Кажется, мы заказали двойную норму пакетов снабжения департаментов в этом месяце. Мы можем отправить их вам?","ЦК: Департамент СнабжениЯ")
