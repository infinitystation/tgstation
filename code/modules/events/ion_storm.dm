...
/datum/round_event/ion_storm/announce()
	if(announceEvent == ION_ANNOUNCE || (announceEvent == ION_RANDOM && prob(ionAnnounceChance)))
		priority_announce("Œ·Ì‡ÛÊÂÌ ËÓÌÌ˚È ¯ÚÓÏ ‚ ‡ÈÓÌÂ ÒÚ‡ÌˆËË. œÓÊ‡ÎÛÈÒÚ‡, ÔÓ‚Â¸ÚÂ ‚Ò∏ Ó·ÓÛ‰Ó‚‡ÌËÂ, Í ÍÓÚÓÓÏÛ ÂÒÚ¸ ‰ÓÒÚÛÔ Û »», Ì‡ ÔÂ‰ÏÂÚ Ó¯Ë·ÓÍ.", "“Â‚Ó„‡! ¿ÌÓÏ‡ÎËﬂ!", 'sound/AI/ionstorm.ogg')
