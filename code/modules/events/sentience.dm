...
/datum/round_event/ghost_role/sentience/spawn_role()
	...
	while(spawned_animals < animals && candidates.len && potential.len)
		...
		to_chat(SA, "<span class='userdanger'>Привет, мир!</span>")
		to_chat(SA, "<span class='warning'>Из-за проклятой радиации/or химикатов в воздухе \
			и/или по счастливой случайности ваш мозг стал развиваться \
			и у вас появилась возможность понимать человеческий язык!</span>")
