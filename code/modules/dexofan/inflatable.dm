...
/obj/structure/inflatable/bullet_act(obj/item/projectile/P)
	var/proj_damage = P.damage
...
/obj/structure/inflatable/attack_tk(var/mob/user, var/damage, var/attack_verb)
	health -= damage
	if(health <= 0)
