				...
				if("Yes")
					...
					for(var/job in notbannedlist)
						...
						if(!msg)
							...
							msg += ", [job]"
					add_note(M.ckey, "Забанен от игры за [msg]. Причина: [reason]. Время: [mins]", null, usr.ckey, 0, null, 0)
					...
					if(reason)
						...
						for(var/job in notbannedlist)
							...
							if(!msg)
								...
								msg += ", [job]"
						add_note(M.ckey, "Перманентно забанен от игры за [msg]. Причина: [reason]", null, usr.ckey, 0, null, 0)
