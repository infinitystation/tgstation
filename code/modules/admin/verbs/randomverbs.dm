...
/client/proc/respawn_character()
	...
	if(record_found)//If they have a record we can determine a few things.
		...
		new_character.visual_age = record_found.fields["visual_age"]
...
/client/proc/cmd_admin_create_centcom_report()
	...
	print_command_report(sanitize_a2u(input), "[announce_command_report ? "Classified " : ""][command_name()] Update", announce_command_report)
...
/client/proc/cmd_admin_allow_respawn(mob/living/M in GLOB.mob_list)
	set category = "Admin"
