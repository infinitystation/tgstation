...
/client/proc/update_server()
	...
	if(confirm == "Cancel")
		return
	if(confirm == "Yes")
		message_admins("[key_name_admin(usr)] Á‡ÔÛÒÚËÎ(‡) Ó·ÌÓ‚ÎÂÌËÂ ÒÂ‚Â‡.")
		log_game("[key_name_admin(usr)] Á‡ÔÛÒÚËÎ(‡) Ó·ÌÓ‚ÎÂÌËÂ ÒÂ‚Â‡.")
		ticker.force_ending = 1
		world << "<b>—≈–¬≈– Œ¡ÕŒ¬Àﬂ≈“—ﬂ ◊≈–≈« 10 —≈ ”Õƒ! —≈–¬≈– Õ≈ ¡”ƒ≈“ –¿¡Œ“¿“‹ Õ≈— ŒÀ‹ Œ Ã»Õ”“!</b><br>Œ·ÌÓ‚ÎÂÌËÂ ËÌËˆËËÓ‚‡ÌÓ ‡‰ÏËÌËÒÚ‡ÚÓÓÏ [usr.key]."
		sleep(100)
		shell("sh update.sh")