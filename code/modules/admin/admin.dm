...
/datum/admins/proc/set_event_status()
	...
	message_admins("[key_name(usr)] èçìåíèë(à) ñòàòóñ ñåðâåðà (Èâåíò) íà [event_on_air ? "Èâåíò" : "Ðåæèì"]")
	log_admin("[key_name(usr)] èçìåíèë(à) ñòàòóñ ñåðâåðà (Èâåíò) íà [event_on_air ? "Èâåíò" : "Ðåæèì"]")
