	...
	if (getBrainLoss() >= 60 && stat != DEAD)
		if (prob(3))
			switch(pick(1,2,3,4,5))
				...
				if(3)
					say(pick("ќ“ќ…ƒ» ќ“ ћ≈Ќя, „≈–“ќ¬ ”Ѕ»…÷ј!!!!", "“ы ебанный аутист!", ";—ѕј—»“≈, ў»“ №ё–»“» ѕџ“ј≈“—я ћ≈Ќя ”Ѕ»“№!!!", "“чо за херн€?????", "¬џ«¬... Ўј““Ћј!!!!!", "ќѕј—Ќќ—“№ —»Ќ√”Ћя–Ќќ—“№ ¬.... ѕор€дке, ха-ха-ха.", "»» ѕравило 22 ќткрой дверь", "this SI mY stATIon......", "„“ќ «ј „≈–“, “џ —≈–№≈«Ќќ „“ќ-Ћ»?", "ѕќЎ≈Ћ Ќј’≈≈≈–!", "’рум-хрум ќЅ¬ќ¬ќЅќЅќЅќ", ";;Ќј Ё“ќ… —“јЌ÷»» Ќ≈“ ¬џ∆»¬Ў»’", "„то за мудаки р€дом со мной?"))
				if(4)
					emote("drool")
				if(5)
