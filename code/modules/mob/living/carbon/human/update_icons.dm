...
/mob/living/carbon/human/update_inv_gloves()
	...
	if(gloves)
		...
		if(gloves.worn_icon && !gloves.alternate_worn_icon)
			standing = image("icon"=gloves.worn_icon, "icon_state"="[t_state]", "layer"=-layer2use)
		if(!standing)
...
/mob/living/carbon/human/update_inv_glasses()
	...
	if(glasses)
		...
		if(glasses.worn_icon && wear_mask.alternate_worn_icon)
			standing = image("icon"=glasses.worn_icon, "icon_state"="[glasses.icon_state]","layer"=-layer2use)
		if(!standing)
...
/mob/living/carbon/human/update_inv_ears()
	...
	if(ears)
		...
		if(ears.worn_icon && !ears.alternate_worn_icon)
			standing = image("icon"=ears.worn_icon, "icon_state"="[ears.icon_state]", "layer"=-layer2use)
		if(!standing)
...
/mob/living/carbon/human/update_inv_shoes()
	...
	if(shoes)
		...
		if(shoes.worn_icon && !shoes.alternate_worn_icon)
			standing = image("icon"=shoes.worn_icon, "icon_state"="[shoes.icon_state]","layer"=-layer2use)
		if(!standing)
...
/mob/living/carbon/human/update_inv_belt()
	...
	if(belt)
		...
		if(belt.worn_icon && !belt.alternate_worn_icon)
			standing = image("icon"=belt.worn_icon, "icon_state"="[t_state]", "layer"=-layer2use)
		if(!standing)
...
/mob/living/carbon/human/update_inv_wear_suit()
	...
	if(istype(wear_suit, /obj/item/clothing/suit))
		...
		if(wear_suit.worn_icon && !wear_suit.alternate_worn_icon)
			standing = image("icon"=wear_suit.worn_icon, "icon_state"="[wear_suit.icon_state]", "layer"=-layer2use)
		if(!standing)
