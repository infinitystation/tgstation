...
/mob/living/carbon/update_inv_wear_mask()
	...
	if(istype(wear_mask, /obj/item/clothing/mask))
		...
		if(wear_mask.worn_icon && !wear_mask.alternate_worn_icon)
			standing = image("icon"=wear_mask.worn_icon, "icon_state"="[wear_mask.icon_state]", "layer"=-layer2use)
		if(!standing)
...
/mob/living/carbon/update_inv_back()
	...
	if(back)
		...
		if(back.worn_icon && !back.alternate_worn_icon)
			standing = image("icon"=back.worn_icon, "icon_state"="[back.icon_state]", "layer"=-layer2use)
		if(!standing)
...
/mob/living/carbon/update_inv_head()
	...
	if(head)
		...
		if(head.worn_icon && !head.alternate_worn_icon)
			standing = image("icon"=head.worn_icon, "icon_state"="[head.icon_state]", "layer"=-layer2use)
		if(!standing)
