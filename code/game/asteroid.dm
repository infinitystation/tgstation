...
/proc/make_mining_asteroid_secret()
	...
	switch(pick(possiblethemes))//what kind of room is this gonna be?
		...
		if("speakeasy")
			...
			treasureitems = list(/obj/item/weapon/melee/transforming/energy/sword/pirate=1,/obj/item/weapon/gun/ballistic/revolver/doublebarrel=1,/obj/item/weapon/storage/backpack/satchel/flat=1,
