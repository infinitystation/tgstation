...
/datum/objective/hijackclone
	explanation_text = "”гнать шаттл экстренной эвакуации и улететь на нЄм одному (или вашему клону)."
	dangerrating = 25
	martyr_compatible = 0
...
/datum/objective/capture/proc/gen_amount_goal()
		...
		explanation_text = "Ќакопить [target_amount] очков захвата с помощью энергетической сети. Ћучше, если они останутся относительно целыми и невредимыми."
		return target_amount
