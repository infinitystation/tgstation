...
/obj/machinery/abductor/experiment/proc/dissection_icon(mob/living/carbon/human/H)
	...
	if(H.dna.species.alt_icon)
		icon_path = H.dna.species.alt_icon
	else
		icon_path = 'icons/mob/human.dmi'
	if(!config.mutant_races || H.dna.species.use_skintones)
		photo = icon("icon" = icon_path, "icon_state" = "[H.skin_tone]_[g]")
	else
		photo = icon("icon" = icon_path, "icon_state" = "[H.dna.species.id]_[g]")
