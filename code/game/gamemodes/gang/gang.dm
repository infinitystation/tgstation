...
/datum/game_mode/proc/add_gangster(datum/mind/gangster_mind, var/gang, var/check = 1)
	...
	gangster_mind.current << "<font color='red'>ѕомогите вашему Ѕоссу взять контроль над станцией, одержав победу над противоположной бандой. ¬ы можете узнать вашего Ѕосса по коричневой иконке с буквой \"B\", но <B>только они знают, кто другие члены вашей банды!</B></font>"
