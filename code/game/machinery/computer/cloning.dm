...
/obj/machinery/computer/cloning/process()
	...
	for(var/datum/data/record/R in records)
		...
		if(pod.growclone(R.fields["ckey"], R.fields["name"], R.fields["UI"], R.fields["SE"], R.fields["mind"], R.fields["mrace"], R.fields["features"], R.fields["factions"], R.fields["age"], R.fields["visual_age"], R.fields["quirks"]))
	...
	if(href_list["task"])
		...
		if(C)
			...
			if(!LAZYLEN(pods))
				...
				playsound(src, 'sound/machines/terminal_prompt_deny.ogg', 50, 0)
			else if(pod.growclone(C.fields["ckey"], C.fields["name"], C.fields["UI"], C.fields["SE"], C.fields["mind"], C.fields["mrace"], C.fields["features"], C.fields["factions"], C.fields["age"], C.fields["visual_age"], C.fields["quirks"]))
...
/obj/machinery/computer/cloning/proc/scan_occupant(occupant)
	...
	if(ishuman(mob_occupant))
		...
		R.fields["age"] = H.age
		R.fields["visual_age"] = H.visual_age
