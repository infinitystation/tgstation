...
/obj/item/weapon/construction/rcd/suicide_act(mob/user)
	user.visible_message("<span class='suicide'>[user] поставил[user.p_e_1()] на RCD режим '—тены' и указывает на свой рот!  ажетс&#255; [user.p_they()] пытал[user.p_e_5()] покончить жизнь самоубийством.</span>")
	return (BRUTELOSS)
...
/obj/item/weapon/construction/rcd/advanced		// TODO@inf-dev пока не будет доработано взаимодействие с ним, эта штука смысла не имеет ~bear1ake@inf-dev
