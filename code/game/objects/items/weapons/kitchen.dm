...
/obj/item/weapon/kitchen/knife/suicide_act(mob/user)
	user.visible_message(pick("<span class='suicide'>[user] разрезает свои кисти ножом! Кажетс&#255; [user.p_they()] пытал[user.p_e_5()] покончить жизнь самоубийством.</span>", \
						"<span class='suicide'>[user] разрезает своё горло ножом! Кажетс&#255; [user.p_they()] пытал[user.p_e_5()] покончить жизнь самоубийством.</span>", \
						"<span class='suicide'>[user] вспарывает свой живот ножом! Кажетс&#255; [user.p_they()] пытал[user.p_e_5()] покончить жизнь сэпппукой.</span>"))
	return (BRUTELOSS)
