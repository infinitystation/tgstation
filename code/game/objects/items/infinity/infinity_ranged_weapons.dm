...
/obj/item/gun/ballistic/automatic/xmg80 //By Terror4000rus
	name = "AA-XMG80"
...
/obj/item/gun/ballistic/automatic/gause //By Terror4000rus
...
/obj/item/gun/ballistic/automatic/gause/CanItemAutoclick()
	return 1
...
/obj/item/gun/ballistic/automatic/mg88/CanItemAutoclick()
	return 1


/obj/item/gun/energy/alien/base //By Terror4000rus
...
/obj/item/melee/classic_baton/telescopic/energy
...
/obj/item/melee/classic_baton/telescopic/energy/New()
	. = ..()
...
/obj/item/melee/classic_baton/telescopic/energy/attack_self(mob/user)
	if(energy < hitcost)
...
/obj/item/melee/classic_baton/telescopic/energy/proc/extend(mob/living/user = null)
...
/obj/item/melee/classic_baton/telescopic/energy/proc/retract(mob/living/user = null)
	icon_state = "telebaton-energy_0"
	item_state = null
...
/obj/item/melee/classic_baton/telescopic/energy/attack(mob/living/target, mob/living/user)
	if(!on)
		return ..()
	add_fingerprint(user)
...
/obj/item/melee/classic_baton/telescopic/energy/proc/baton_hit(mob/living/carbon/target, mob/living/user, intent)
	current_combo++
