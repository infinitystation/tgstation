...
/obj/item/storage/box/security/centcom
	desc = "—тандартный набор снаряжения дл€ офицера охраны ÷ ."
	icon_state = "implant"

/obj/item/storage/box/security/centcom/New()
	..()
...
/obj/item/storage/box/mining/survival
	name = "survival pack"
...
/obj/item/storage/box/mining/survival/New()
	..()
	new /obj/item/reagent_containers/pill/patch/silver_sulf(src)
	new /obj/item/reagent_containers/pill/patch/styptic(src)
	new /obj/item/reagent_containers/hypospray/medipen/survival(src)
	new /obj/item/reagent_containers/hypospray/medipen/survival(src)
	new /obj/item/reagent_containers/food/snacks/donkpocket/warm(src)
	new /obj/item/reagent_containers/food/snacks/donkpocket/warm(src)
...
/obj/item/storage/box/hug/suicide_act(mob/user)
	user.visible_message("<span class='suicide'>[user] зажимает &#255;ремную вену с помощью коробки обнимашек! ѕредположительно, после этого эта коробка больше не объ€тий...</span>")
	return (BRUTELOSS)
...
/obj/item/storage/box/ppancakes/New()
...
/obj/item/storage/box/ppancakes/New()
	..()
	contents = list()
	new /obj/item/reagent_containers/food/snacks/pancake(src)
	new /obj/item/reagent_containers/food/snacks/pancake(src)
	new /obj/item/reagent_containers/food/snacks/pancake(src)
	new /obj/item/reagent_containers/food/snacks/pancake(src)
	new /obj/item/reagent_containers/food/snacks/pancake(src)
