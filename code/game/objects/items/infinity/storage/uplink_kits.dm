...
/obj/item/storage/box/syndie_kit/imp_fuck_the_nt
	name = "boxed FUCK THE NT implants (with injector)"
	desc = "break up you and your friends from NT usurpation!"

/obj/item/storage/box/syndie_kit/imp_fuck_the_nt/New()
	..()
	var/obj/item/implanter/O = new(src)
	O.imp = new /obj/item/implant/antiloyalty(O)
	O.update_icon()
	for(var/i in 1 to 6)
		new /obj/item/implantcase/antiloyalty(src)
	return
