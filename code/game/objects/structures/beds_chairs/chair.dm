...
/obj/structure/bed/chair/shuttle_blue
	name = "shuttle chair"
	desc = "It looks comfy."
...
/obj/structure/bed/chair/shuttle_blue/New()
	armrest = image("icons/obj/chairs2.dmi", "shblue_arm")
	armrest.layer = MOB_LAYER + 0.1
	return ..()

/obj/structure/bed/chair/shuttle_blue/post_buckle_mob(mob/living/M)
	if(buckled_mob)
		overlays += armrest
	else
		overlays -= armrest

/obj/structure/bed/chair/shuttle_black
	name = "shuttle chair"
	desc = "It looks comfy."
	icon = 'icons/obj/chairs2.dmi'
	icon_state = "shblack"
...
/obj/structure/bed/chair/shuttle_black/New()
	armrest = image("icons/obj/chairs2.dmi", "shblack_arm")
	armrest.layer = MOB_LAYER + 0.1
	return ..()

/obj/structure/bed/chair/shuttle_black/post_buckle_mob(mob/living/M)
	if(buckled_mob)
		overlays += armrest
	else
		overlays -= armrest
