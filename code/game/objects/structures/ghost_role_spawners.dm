...
/obj/effect/mob_spawn/human/ash_walker/special(mob/living/new_spawn)
	...
	to_chat(new_spawn, "<b>Тащите тела мертвых существ и чудовищ к вашему гнезду. Они будут поглащены и после нескольких тел, вы получите себе подобного собрата. Слава Некрополису!</b>")
	if(ishuman(new_spawn))
		var/mob/living/carbon/human/H = new_spawn
		H.underwear = "Nude"
		H.update_body()
