...
/obj/structure/closet/gmcloset/New()
	...
	new /obj/item/clothing/suit/storage/armor/vest/alt(src)
...
/obj/structure/closet/lawcloset/New()
	...
	new /obj/item/clothing/suit/storage/toggle/lawyer(src)
	new /obj/item/clothing/under/lawyer/purpsuit(src)
	new /obj/item/clothing/suit/storage/toggle/lawyer/purple(src)
	new /obj/item/clothing/under/lawyer/blacksuit(src)
	new /obj/item/clothing/suit/storage/toggle/lawyer/black(src)
...
/obj/structure/closet/wardrobe/white/medical/New()
	...
	new /obj/item/clothing/suit/toggle/labcoat/emt(src)
	new /obj/item/clothing/suit/toggle/labcoat/emt/ems(src)
	new /obj/item/clothing/suit/toggle/labcoat/emt/ems(src)
	for(var/i in 1 to 3)
		new /obj/item/clothing/shoes/sneakers/white(src)
	for(var/i in 1 to 3)
		new /obj/item/clothing/shoes/ballets/white/medical(src)
	for(var/i in 1 to 3)
...
/obj/structure/closet/wardrobe/robotics_black/New()
	...
	new /obj/item/clothing/gloves/color/latex/blacklong(src)
	new /obj/item/clothing/under/rank/roboticist/newrob(src)
	new /obj/item/clothing/under/rank/roboticist/newrob(src)
	new /obj/item/clothing/suit/storange/sc_labcoat(src)
	new /obj/item/clothing/suit/storange/sc_labcoat(src)
	if(prob(40))
...
/obj/structure/closet/wardrobe/science_white/New()
	...
	for(var/i in 1 to 3)
		new /obj/item/clothing/under/rank/scientist/newsci(src)
	for(var/i in 1 to 3)
