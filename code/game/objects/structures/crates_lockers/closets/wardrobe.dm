...
/obj/structure/closet/wardrobe/black/New()
	...
	if(prob(25))
		new /obj/item/clothing/suit/storage/jacket/leather(src)
	if(prob(20))
		new /obj/item/clothing/suit/storage/jacket/leather/overcoat(src)
	for(var/i in 1 to 3)
...
/obj/structure/closet/wardrobe/mixed/New()
	...
	contents = list()
	if(prob(40))
		new /obj/item/clothing/suit/storage/jacket(src)
	if(prob(40))
		new /obj/item/clothing/suit/storage/jacket(src)
	new /obj/item/clothing/under/color/white(src)
	new /obj/item/clothing/under/color/blue(src)
