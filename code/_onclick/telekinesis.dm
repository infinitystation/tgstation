...
/obj/item/tk_grab/suicide_act(mob/user)
	user.visible_message("<span class='suicide'>[user] пытаетс&#255; задушить себ&#255; телекинезом!  ажетс&#255; [user.p_they()] пытал[user.p_e_5()] покончить жизнь самоубийством!</span>")
	return (OXYLOSS)
