...
/obj/screen/alert/drunk //Not implemented
	name = "Drunk"
	desc = "Вы находитесь в состо&#1103;нии алкогольного опь&#1103;нени&#1103;. Из-за этого, у вас может быть нарушена речь и моторика. Постарайтесь отрезветь."
	icon_state = "drunk"

/obj/screen/alert/drunk2
	name = "Drunk"
	desc = "ВЫ НАПИЛИСЬ КАК СВИНЬЯ! ОТРЕЗВЕЙТЕ ПОКА НЕ СДОХЛИ!"
	icon_state = "drunk2"
