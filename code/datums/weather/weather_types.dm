...
/datum/weather/floor_is_lava //The Floor is Lava: Makes all turfs damage anyone on them unless they're standing on a solid object.
	...
	pda_start_up_sound = 'sound/machines/pda_quest.ogg'
	pda_duration_sound = 'sound/machines/pda_quest.ogg'
...
/datum/weather/rad_storm
	...
	area_type = /area
	protected_areas = list(/area/maintenance, /area/ai_monitored/turret_protected/ai_upload, /area/ai_monitored/turret_protected/ai_upload_foyer, /area/ai_monitored/turret_protected/ai, /area/crew_quarters/sleep/one, /area/crew_quarters/sleep/two, /area/crew_quarters/sleep/three, /area/crew_quarters/sleep/four, /area/crew_quarters/sleep/five, /area/crew_quarters/sleep/six, /area/storage/emergency, /area/storage/emergency2, /area/shuttle, /area/security/barracks/one, /area/security/barracks/two)
	target_z = ZLEVEL_STATION
