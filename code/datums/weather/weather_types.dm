...
/datum/weather/rad_storm
	...
	/area/ai_monitored/turret_protected/ai, /area/storage/emergency, /area/storage/emergency2, /area/shuttle, /area/security/barracks/one, /area/security/barracks/two)
	target_z = ZLEVEL_STATION
