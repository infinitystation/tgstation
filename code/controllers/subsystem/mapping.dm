...
/datum/controller/subsystem/mapping/proc/loadWorld()
	...
	TryLoadZ(config.GetFullMapPath(mf = config.extra_cenctomm), FailedZs, ZLEVEL_CENTCOM)
	TryLoadZ(config.GetFullMapPath(mf = config.extra_derelict), FailedZs, ZLEVEL_SPACEMIN)
	TryLoadZ(config.GetFullMapPath(mf = config.extra_minemap), FailedZs, ZLEVEL_LAVALAND)
